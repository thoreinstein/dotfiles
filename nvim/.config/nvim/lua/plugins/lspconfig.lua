...
return {
  ...
  config = function()
    ...
    local function get_lspconfig_server(name)
    ...
    local function setup_server(name, opts)
      ...
      local server = get_lspconfig_server(name)
      if not server then
        return false
      end
    ...
    M.defaults = function()
      ...
      setup_server("lua_ls", { settings = lua_lsp_settings })
      setup_server("gopls", { settings = gopls_settings })
      if not setup_server("ts_ls", { init_options = ts_ls_settings.init_options }) then
        setup_server("tsserver", { init_options = ts_ls_settings.init_options })
      end
      setup_server("svelte", { settings = svelte_settings })
    end
